...
<meta name="viewport" content="width=device-width,initial-scale=1"><title>FinSearchComp 审计</title>
<style>
...
.question,footer{{color:var(--muted)}}code{{background:#eef2f7;padding:2px 6px;border-radius:5px;word-break:break-word}}.metrics{{display:flex;gap:8px;flex-wrap:wrap}}.metrics span{{background:#f2f4f7;border-radius:8px;padding:5px 9px}}
...
<nav><a href="#trajectory">完整轨迹</a><a href="#cases">六个案例</a><a href="report.md">汇报稿</a><a href="trace.json">JSON 轨迹</a></nav>
...
<footer>详情：<a href="report.md">report.md</a> · <a href="trace.json">trace.json</a> · <a href="metrics.csv">metrics.csv</a></footer>
</main></body></html>"""
