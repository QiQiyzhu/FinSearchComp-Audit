...
### 2026-08-13 ATLAS-PIT-XBRL 综合更新

- 独立重审发现旧泄漏指标没有把日期缺失与确认安全分开；普通Agent旧20题中已确认3条最终证据晚于截止日；
- 冻结20道全新的2023–2024历史截止日题、三层PIT审计器、联合可靠回答率和六项成功判据；
- 正式40/40条有效Claude trace：普通Agent准确率65%、覆盖率90%，ATLAS为100%/100%；
- 候选未来来源80/392对0/32，涉及题数19/20对0/20；最终未来证据7/55对0/84，涉及6/20对0/20；
- 候选时间元数据覆盖率30.6%对100%，最终证据覆盖率36.4%对100%；
- 数值逐题7胜/13平/0负，配对提升+35个百分点，bootstrap 95% CI为+15至+55；
- 1次HTTP 524按运行中提交的协议修订仅替代一次，原错误公开保留；题目、Gold、评分与日期规则未变。
